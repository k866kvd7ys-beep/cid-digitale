...
String customerIncidentEventLabel(
  ...
  return switch ((type, language)) {
    ...
    (CustomerIncidentEventType.hail, _) => 'Hagel',
    ...
    (CustomerIncidentEventType.marten, _) => 'Marder',
    ...
    (CustomerIncidentEventType.theft, _) => 'Diebstahl / Diebstahlversuch',
    ...
    (CustomerIncidentEventType.animalCollision, _) => 'Tierkollision',
