...
// Payload compatto per il QR: solo id pratica, hash di integrità e codice officina.
String generaStringaQrSicura(Incidente inc) {
  return 'CID:${inc.id}|H:${inc.hashIntegrita}|O:${inc.codiceOfficina}';
}
...
class QrCarrozzeriaPage extends StatelessWidget {
  final Incidente incidente;
  ...
  Future<void> _condividiQr(BuildContext context) async {
    // MODIFICA QUI - condivisione QR come PNG con fallback testo
    final qrData = generaStringaQrSicura(incidente);
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    width: double.infinity,
                    child: ElevatedButton.icon(
                      onPressed: () => _condividiQr(context),
...
class _DettaglioIncidentePageState extends State<DettaglioIncidentePage> {
  ...
  Future<void> _impostaColpevole(String value) async {
    ...
    setState(() => incidente = updatedWithHash);
    unawaited(_verificaHashIntegrita());
  }
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (_) =>
                                  QrCarrozzeriaPage(incidente: incidente),
                            ),
                          );
                        },
